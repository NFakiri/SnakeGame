...
public class GamePanel extends JPanel implements ActionListener{
	...
	static final int UNIT_SIZE = 25; // changes the size of all items.
	...
	public void draw(Graphics g) {
		...
		if (running) {
			for (int i = 0; i<SCREEN_HEIGHT/UNIT_SIZE; i++) {
				g.drawLine(i*UNIT_SIZE, 0, i*UNIT_SIZE, SCREEN_HEIGHT); // y axis matrix.
				g.drawLine(0, i*UNIT_SIZE, SCREEN_WIDTH, i*UNIT_SIZE); // x axis matrix.
			}
